  ...
  <section class="py-5 bg-white text-center">
    <div class="container">
      <h1 class="fw-bold text-primary mb-4">
        You're one search away <br /> from the right tutor
      </h1>

      <div class="d-flex justify-content-center">
        <div class="search-wrapper position-relative" style="max-width: 600px; width: 100%;">
          <input
            v-model="userInput"
            type="text"
            class="form-control search-input ps-4 pe-5 animated-input"
            :placeholder="!userTyping ? displayText + (showCursor ? '|' : '') : ''"
            @focus="handleFocus"
            @input="handleInput"
          />
