  ...
  directionsService.route(
    ...
    (result, status) => {
      if (status === "OK") {
        ...
        toast.error("Directions request failed: " + status, "Route Error");
      }
    }
  );
}
        ...
        content: `
          <div style="font-size:14px;">
            ...
            <div style="margin-bottom:8px;">
              <button id="drive-btn-${
                a.id
              }" class="btn btn-sm btn-outline-primary me-1">🚗 Drive</button>
              <button id="walk-btn-${
                a.id
              }" class="btn btn-sm btn-outline-success me-1">🚶 Walk</button>
              <button id="transit-btn-${
                a.id
              }" class="btn btn-sm btn-outline-info">🚇 Transit</button>
              <button id="apply-btn-${
                a.id
              }" class="btn btn-sm btn-outline-info" @click="router.push{path: '/dashboard'}">Apply</button>
            </div>
